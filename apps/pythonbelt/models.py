...
class UserManager(models.Manager):
    def register(self, data):
        ...
        user = self.filter(username = data['username']) #check if false
...
class TripSchedule(models.Model):
    ...
    usertrip = models.ForeignKey(User, related_name="usertrip") #this is the foreignkey, look up at create schedule, that's where it will be referenced and used
